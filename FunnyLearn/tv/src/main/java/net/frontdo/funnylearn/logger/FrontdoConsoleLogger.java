...
/**
 * @ClassName: FrontdoConsoleLogger
 * @Description:控制台日志
 * @author LiuJun
 * @date 2014-12-29 下午7:09:33
 * 
 */
public class FrontdoConsoleLogger implements IFrontdoLogger {
	private static final String TAG = "FrontdoConsoleLogger";

	private int level; //日志级别

	public FrontdoConsoleLogger(int level) {
		this.level = level;
	}
